...
export function createGoogleRedirectUri(): string {
  return `${globalThis.location.origin}${globalThis.location.pathname}`;
}

export function readGoogleCallback(): OAuthCallbackParams | undefined {
...
export function clearGoogleCallbackFromLocation(): void {
  globalThis.history.replaceState({}, document.title, globalThis.location.pathname);
}

export function readClientError(error: unknown): string {
