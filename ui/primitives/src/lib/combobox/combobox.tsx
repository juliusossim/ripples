...
import type {
  ...
  ComboboxValueProps,
  UseComboboxAnchorResult,
} from './combobox.types';

const Combobox = ComboboxPrimitive.Root;

function ComboboxValue({ ...props }: ComboboxValueProps): React.ReactElement {
...
function ComboboxTrigger({
  ...
  children,
  ...props
}: ComboboxTriggerProps): React.ReactElement {
  return (
...
function ComboboxContent({
  ...
  anchor,
  ...props
}: ComboboxContentProps): React.ReactElement {
  return (
...
function ComboboxCollection({ ...props }: ComboboxCollectionProps): React.ReactElement {
...
function ComboboxChip({
  ...
  showRemove = true,
  ...props
}: ComboboxChipProps): React.ReactElement {
  return (
...
function useComboboxAnchor(): UseComboboxAnchorResult {
